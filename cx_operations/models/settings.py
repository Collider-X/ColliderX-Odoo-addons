...
# To set the company record with data
class ResCompany(models.Model):
    ...
    @api.model
    def set_colliderx_company_data(self):
        ...
        self.browse(1).write({
            'name': u"ColliderX",
            'report_header': u"The 1st Open Source and Crowdsourced R&D Hub focusing on Blockchain and related technologies",  
            'logo': logo,
			'email': u"info@collider-x.org", # catch all email for information
			'website': u"https://www.collider-x.org",
            'city': u"Toronto",
			'state_id': id_ontario,
...
# To set the company record with company data
